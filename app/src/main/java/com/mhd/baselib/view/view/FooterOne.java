 ...
 */
public class FooterOne extends BaseView<String, ViewHeaderOneBinding> {


    public FooterOne(Context context, Object data, ViewGroup parent) {
    ...
    protected void initListener(View view, boolean isUpdate) {
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(v.getContext(),"我是底布局1",Toast.LENGTH_SHORT).show();
            }
        });
    }
