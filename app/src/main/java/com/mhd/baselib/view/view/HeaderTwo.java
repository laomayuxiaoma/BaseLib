 ...
 */
public class HeaderTwo extends BaseView<String, ViewHeaderOneBinding> {


    public HeaderTwo(Context context, Object data, ViewGroup parent) {
    ...
    protected void initListener(View view, boolean isUpdate) {
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(v.getContext(),"我是头布局2",Toast.LENGTH_SHORT).show();
            }
        });
    }
